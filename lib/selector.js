 ...
 *   from the `::run` or '::runSync' method's settings.selectorSettings
 *   argument, if any.
 * @property {Object} [defaults] - Set to provide default values for the
...
class Selector {
	...
	/**
	 * At the very beginning of the run, selector settings are passed to this
	 * method in order to ensure that they are valid. If they aren't, this
	 * method should throw an appropriate error.
	 * @param {Object} settings - Selector configuration object
	 * @returns {undefined}
	 */
	static validateSettings() {
		// Override this method to provide settings validation.
	}
