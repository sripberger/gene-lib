...
/**
 * Gets an array of random chromosome indices, such at the probability of any
 * one index being selected is 0.5.
 * @param {number} length - Length of the chromosome.
 * @returns {Arrray<number>} Contains a random set of integers in [0, length].
 */
exports.getRandomIndices = function(length) {
	let indices = [];
...
/**
 * Gets an array of random chromosome indices such that half of the possible
 * indices rounded down will always be selected.
 * @param {number} length - Length of the chromosome.
 * @returns {Arrray<number>} Contains a random set of integers in [0, length].
 */
exports.pickRandomIndices = function(length) {
...
exports.uniformCrossover = function(left, right) {
	let indices = exports.getRandomIndices(left.length);
