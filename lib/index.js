 ...
 *       each generation. Receives an object argument in the same format as the
 *       end result object, detailing the current state of the algorithm.
 *       Useful for logging progress or debugging.
 *   @returns {Object|Promise<Object>} - The result object produced by the
 *      algorithm, or a Promise resolving with it. `::run` will return a
